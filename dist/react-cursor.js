...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RefCursor = __webpack_require__(28);
	
	var _RefCursor2 = _interopRequireDefault(_RefCursor);
	
	var _ImmutableOptimizations = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilMemoized = __webpack_require__(3);
	
	var _utilMemoized2 = _interopRequireDefault(_utilMemoized);
	
	var _CursorOperations2 = __webpack_require__(5);
	
	var _CursorOperations3 = _interopRequireDefault(_CursorOperations2);
	
	var _utilAssociative = __webpack_require__(15);
	
	var _utilHashRecord = __webpack_require__(22);
	
	var _utilHashRecord2 = _interopRequireDefault(_utilHashRecord);
	
	var _utilRefToHash = __webpack_require__(24);
	
	var _utilRefToHash2 = _interopRequireDefault(_utilRefToHash);
	
	var _utilDeepFreeze = __webpack_require__(25);
	
	var _utilDeepFreeze2 = _interopRequireDefault(_utilDeepFreeze);
	
	var _ReactAdapter = __webpack_require__(27);
	
	var debug = process.env.NODE_ENV !== 'production';
	
	var makeRefinedSwap = (0, _utilMemoized2['default'])(function (swapFn, paths) {
	  return (0, _utilRefToHash2['default'])(swapFn) + (0, _utilHashRecord2['default'])(paths);
	}, function (swapFn, paths) {
	  return function (f) {
	    return swapFn((0, _utilAssociative.rootAt)(paths, f));
	  };
	});
	...
	var Cursor = (function (_CursorOperations) {
	  ...
	  function Cursor(value, swapFn) {
	    ...
	    this.refine = function () {
	      ...
	      return NewCursor((0, _utilAssociative.getIn)(value, morePaths), makeRefinedSwap(swapFn, morePaths));
	    };
	    ...
	    debug && (0, _utilDeepFreeze2['default'])(value);
	  }
	
	  return Cursor;
	})(_CursorOperations3['default']);
	
	var NewCursor = (0, _utilMemoized2['default'])(function (value, swap) {
	  return (0, _utilRefToHash2['default'])(swap) + (0, _utilHashRecord2['default'])(value);
	}, function (value, swap) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashIdentity = __webpack_require__(4);
	...
	function memoized(hasher, f) {
	  ...
	  if (hasher === undefined) hasher = _lodashIdentity2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _updateIn = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashReduce = __webpack_require__(16);
	...
	var getIn = function getIn(tree, paths) {
	  return (0, _lodashReduce2['default'])(paths, get, tree);
	};
	exports.getIn = getIn;
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseEach = __webpack_require__(17),
	    ...
	    baseReduce = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hashString = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashIsobject = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeSwapFromReact = (0, _utilMemoized2['default'])(_utilRefToHash2['default'], function (cmp) {
	  return cmp.setState.bind(cmp);
	});
	exports.makeSwapFromReact = makeSwapFromReact;
	var makeDerefFromReact = (0, _utilMemoized2['default'])(_utilRefToHash2['default'], function (cmp) {
	  return function () {
	    return cmp.state;
	  };
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeRefinedDeref = (0, _utilMemoized2['default'])(function (deref, paths) {
	  return (0, _utilRefToHash2['default'])(deref) + (0, _utilHashRecord2['default'])(paths);
	}, function (deref, paths) {
	  return function () {
	    return (0, _utilAssociative.getIn)(deref(), paths);
	  };
	});
	...
	var RefCursor = (function (_CursorOperations) {
	  ...
	  function RefCursor(deref, swapFn) {
	    ...
	    _get(Object.getPrototypeOf(RefCursor.prototype), 'constructor', this).call(this);
	    this.value = deref;
	    this.refine = function () {
	      for (var _len = arguments.length, morePaths = Array(_len), _key = 0; _key < _len; _key++) {
	        morePaths[_key] = arguments[_key];
	...
	var NewRefCursor = (0, _utilMemoized2['default'])(function (deref, swap) {
	  return (0, _utilRefToHash2['default'])(deref) + (0, _utilRefToHash2['default'])(swap);
	}, function (deref, swap) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashOmit = __webpack_require__(30);
	
	var _lodashOmit2 = _interopRequireDefault(_lodashOmit);
	
	var _lodashIsequal = __webpack_require__(36);
	...
	function ImmutableOptimizations() {
	  ...
	  return {
	    shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
	      ...
	      var valuesChanged = !(0, _lodashIsequal2['default'])((0, _lodashOmit2['default'])(nextProps, noValueCheckFields), (0, _lodashOmit2['default'])(this.props, noValueCheckFields));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseDifference = __webpack_require__(31),
	    baseFlatten = __webpack_require__(33),
